...
const els = {
  ...
  signOutButton: document.querySelector("#signOutButton"), prizeGate: document.querySelector("#prizeGate"), prizeWheel: document.querySelector("#prizeWheel"), prizeHubValue: document.querySelector("#prizeHubValue"), prizeSpin: document.querySelector("#prizeSpin"), prizeResult: document.querySelector("#prizeResult"), prizeContinue: document.querySelector("#prizeContinue")
};
...
function trapModalFocus(event) {
  ...
  const modal = els.prizeGate.classList.contains("is-open") ? els.prizeGate
...
function enterApp() {
  ...
  if (state.user.prizeWheelPending) setTimeout(openPrizeWheel, 100);
